...
## 方位
Park 1 中心区域·蒸汽列车（Train No. 39）入园的第一站

## 相邻节点
- Train Station（西端·Train No. 39 到达）
- Abernathy Ranch（东端外·约1英里）
- Town Outskirts（镇周）

## 环境与氛围
西部小镇：主街东西主轴线、木质建筑、马蹄声、酒馆音乐、尘土

## 常驻NPC
- CHAR_Dolores Abernathy（日常循环）
- CHAR_Maeve Millay（Mariposa 老鸨）
- CHAR_Teddy Flood（循环）
