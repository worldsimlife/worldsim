...
| 出场角色 | [具名角色名(PC/状态)，逗号分隔] (例: Guest(PC), Angela, Sheriff(背景)) |
| 焦外/在场 | [具名焦外角色及其位置；REGION.常驻NPC 按当前时刻时间线命中本场者必列此处或出场角色；仅无 CHAR_.md 的纯背景可不列] (例: Robert Ford(Mesa Hub 办公室·未出场)) |
